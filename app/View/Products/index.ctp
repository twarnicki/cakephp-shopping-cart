...
<?php echo $this->Form->button('<i class="icon-shopping-cart icon-white"></i> Add to Cart', array('class' => 'btn btn-small btn-primary addtocart', 'id' => $product['Product']['id'], 'escape' => false));?>

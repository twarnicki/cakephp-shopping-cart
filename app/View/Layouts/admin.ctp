...
<?php echo $this->Html->css(array('bootstrap.css', 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/themes/smoothness/jquery-ui.css', 'admin.css', 'bootstrap-responsive.css')); ?>
